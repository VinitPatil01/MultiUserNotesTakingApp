...
import {getGroupNotes} from '../Services/notesServices';
import {useNavigate} from 'react-router-dom';
const GroupNotesComponent = () => {
  ...
  useEffect(() => {
    var token = getToken();
    const fetchSelfNotes = async () => {
      try {
        const response = await getGroupNotes(token);
...
export default GroupNotesComponent;