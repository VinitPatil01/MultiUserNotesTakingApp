...
const DashboardComponent = () => {
  ...
  const renderContent = () => {
    switch (activeTab) {
      case "Dashboard":
        return <h1 className="text-3xl font-semibold text-gray-800">Welcome To Notesphere</h1>;
        
      case "My Notes":
        return <MyNotesComponent />;
      case "Group Notes":
        return <h1 className="text-3xl font-semibold text-gray-800">Group Notes Content</h1>;
      case "Upload Notes":
